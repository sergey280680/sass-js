...
var paths = {
    input: pathBase + '/src/',
    output: pathBase + '/dist/',
    scripts: {
        input: pathBase + '/src/js/*',
        polyfills: '.polyfill.js',
        output: pathBase + '/dist/js/'
    },
    styles: {
        input: pathBase + '/src/sass/**/*.{scss,sass}',
        output: pathBase + '/dist/css/'
    },
    fonts: {
        input: pathBase + '/src/fonts/**/*.{eot,svg,ttf,wott}',
        output: pathBase + '/dist/fonts/'
    },
    svgs: {
        input: pathBase + '/src/svg/*.svg',
        output: pathBase + '/dist/svg/'
    },
    staticFiles: {
        input: pathBase + '/src/static/**/*',
        output: pathBase + '/dist/'
    },
    reload: './dist/'
};
...
var jsTasks = lazypipe()
    .pipe(header, banner.full, {package: config})
    .pipe(optimizejs)
    .pipe(dest, paths.scripts.output)
    .pipe(rename, {suffix: '.min'})
    .pipe(uglify)
    .pipe(optimizejs)
    .pipe(header, banner.min, {package: config})
    .pipe(dest, paths.scripts.output);
...
// staticFiles static files into output folder
var copyFiles = function (done) {

    // Make sure this feature is activated before running
    if (!settings.staticFiles) return done();
